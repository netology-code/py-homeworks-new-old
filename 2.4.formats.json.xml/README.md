# Домашнее задание к лекции 2.4 «Работа с разными форматами данных»

Взять из [github-репозитория](https://github.com/netology-code/py-homeworks-new/tree/master/2.4.formats.json.xml/files) все файлы с новостями newsafr.json и newsafr.xml
